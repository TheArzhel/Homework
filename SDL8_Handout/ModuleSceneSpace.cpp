...
bool ModuleSceneSpace::Start()
{
	...
	// Enemies ---
	App->enemies->AddEnemy(ENEMY_TYPES::COOKIES, 300, 80);
	App->enemies->AddEnemy(ENEMY_TYPES::COOKIES, 325, 80);
	App->enemies->AddEnemy(ENEMY_TYPES::COOKIES, 340, 80);
	App->enemies->AddEnemy(ENEMY_TYPES::COOKIES, 365, 80);
